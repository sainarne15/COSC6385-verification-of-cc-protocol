/******************************
  Program "futurebus.m" compiled by "Murphi Release 3.1"

  Murphi Last Modefied Date: "Jan 29 1999"
  Murphi Last Compiled date: "May  5 2023"
 ******************************/
...
#define PROTOCOL_NAME "futurebus"
#define BITS_IN_WORLD 96
#define ALIGN
...
/*** Variable declaration ***/
mu_1_Message mu_send_msg("send_msg",80);
...
bool mu__boolexpr5;
bool mu__boolexpr6;
  if ((mu_proc_state[mu_i].mu_state) == (mu_FB_SU)) mu__boolexpr6 = TRUE ;
  else {
  mu__boolexpr6 = ((mu_proc_state[mu_i].mu_state) == (mu_FB_PR)) ; 
}
  if (mu__boolexpr6) mu__boolexpr5 = TRUE ;
  else {
  mu__boolexpr5 = ((mu_proc_state[mu_i].mu_state) == (mu_FB_PSU)) ; 
}
  if (mu__boolexpr5) mu__boolexpr4 = TRUE ;
  else {
  mu__boolexpr4 = ((mu_proc_state[mu_i].mu_state) == (mu_FB_PEMR)) ; 
}
  if (mu__boolexpr4) mu__boolexpr3 = TRUE ;
  else {
  mu__boolexpr3 = ((mu_proc_state[mu_i].mu_state) == (mu_FB_EU)) ; 
}
if ( mu__boolexpr3 )
{
...
bool mu__boolexpr9;
bool mu__boolexpr10;
  if ((mu_proc_state[mu_m].mu_state) == (mu_FB_PEMR)) mu__boolexpr10 = TRUE ;
  else {
  mu__boolexpr10 = ((mu_proc_state[mu_m].mu_state) == (mu_FB_PSU)) ; 
}
  if (mu__boolexpr10) mu__boolexpr9 = TRUE ;
  else {
  mu__boolexpr9 = ((mu_proc_state[mu_m].mu_state) == (mu_FB_EU)) ; 
}
  if (mu__boolexpr9) mu__boolexpr8 = TRUE ;
  else {
  mu__boolexpr8 = ((mu_proc_state[mu_m].mu_state) == (mu_FB_EM)) ; 
}
  if (mu__boolexpr8) mu__boolexpr7 = TRUE ;
  else {
  mu__boolexpr7 = ((mu_proc_state[mu_m].mu_state) == (mu_FB_SU)) ; 
}
if ( mu__boolexpr7 )
{
...
bool mu__boolexpr11;
  if (!((mu_one_flag) == (mu_false))) mu__boolexpr11 = FALSE ;
  else {
  mu__boolexpr11 = ((mu_transaction_flag) == (mu_false)) ; 
}
if ( mu__boolexpr11 )
{
mu_one_flag = mu_true;
...
bool mu__boolexpr12;
  if ((mu_p.mu_state) == (mu_FB_EM)) mu__boolexpr12 = TRUE ;
  else {
  mu__boolexpr12 = ((mu_p.mu_state) == (mu_FB_EU)) ; 
}
...
bool mu__boolexpr14;
bool mu__boolexpr15;
  if (!((mu_p.mu_state) == (mu_FB_PR))) mu__boolexpr15 = FALSE ;
  else {
  mu__boolexpr15 = ((mu_transaction_flag) == (mu_false)) ; 
}
  if (!(mu__boolexpr15)) mu__boolexpr14 = FALSE ;
  else {
  mu__boolexpr14 = ((mu_one_flag) == (mu_true)) ; 
}
...
bool mu__boolexpr16;
bool mu__boolexpr17;
  if (!((mu_p.mu_state) == (mu_FB_PR))) mu__boolexpr17 = FALSE ;
  else {
  mu__boolexpr17 = ((mu_transaction_flag) == (mu_false)) ; 
}
  if (!(mu__boolexpr17)) mu__boolexpr16 = FALSE ;
  else {
  mu__boolexpr16 = ((mu_one_flag) == (mu_true)) ; 
}
              if (mu__boolexpr16) {
                if ( ( TRUE  ) )
                  return;
...
bool mu__boolexpr18;
bool mu__boolexpr19;
  if (!((mu_p.mu_state) == (mu_FB_PR))) mu__boolexpr19 = FALSE ;
  else {
  mu__boolexpr19 = ((mu_transaction_flag) == (mu_false)) ; 
}
  if (!(mu__boolexpr19)) mu__boolexpr18 = FALSE ;
  else {
  mu__boolexpr18 = ((mu_more_flag) == (mu_true)) ; 
}
...
bool mu__boolexpr20;
bool mu__boolexpr21;
  if (!((mu_p.mu_state) == (mu_FB_PR))) mu__boolexpr21 = FALSE ;
  else {
  mu__boolexpr21 = ((mu_transaction_flag) == (mu_false)) ; 
}
  if (!(mu__boolexpr21)) mu__boolexpr20 = FALSE ;
  else {
  mu__boolexpr20 = ((mu_more_flag) == (mu_true)) ; 
}
              if (mu__boolexpr20) {
                if ( ( TRUE  ) )
                  return;
...
bool mu__boolexpr22;
bool mu__boolexpr23;
  if (!((mu_p.mu_state) == (mu_FB_PR))) mu__boolexpr23 = FALSE ;
  else {
  mu__boolexpr23 = ((mu_transaction_flag) == (mu_false)) ; 
}
  if (!(mu__boolexpr23)) mu__boolexpr22 = FALSE ;
  else {
  mu__boolexpr22 = ((mu_more_flag) == (mu_true)) ; 
}
...
bool mu__boolexpr24;
bool mu__boolexpr25;
  if (!((mu_p.mu_state) == (mu_FB_PR))) mu__boolexpr25 = FALSE ;
  else {
  mu__boolexpr25 = ((mu_transaction_flag) == (mu_false)) ; 
}
  if (!(mu__boolexpr25)) mu__boolexpr24 = FALSE ;
  else {
  mu__boolexpr24 = ((mu_more_flag) == (mu_true)) ; 
}
              if (mu__boolexpr24) {
                if ( ( TRUE  ) )
                  return;
...
bool mu__boolexpr26;
  ...
  mu__boolexpr26 = (mu_transaction_flag) ; 
}
...
bool mu__boolexpr28;
bool mu__boolexpr29;
  if ((mu_p.mu_state) == (mu_FB_EU)) mu__boolexpr29 = TRUE ;
  else {
  mu__boolexpr29 = ((mu_p.mu_state) == (mu_FB_SU)) ; 
}
  if (mu__boolexpr29) mu__boolexpr28 = TRUE ;
  else {
  mu__boolexpr28 = ((mu_p.mu_state) == (mu_FB_PSU)) ; 
}
...
bool mu__boolexpr30;
bool mu__boolexpr31;
  if ((mu_p.mu_state) == (mu_FB_EU)) mu__boolexpr31 = TRUE ;
  else {
  mu__boolexpr31 = ((mu_p.mu_state) == (mu_FB_SU)) ; 
}
  if (mu__boolexpr31) mu__boolexpr30 = TRUE ;
  else {
  mu__boolexpr30 = ((mu_p.mu_state) == (mu_FB_PSU)) ; 
}
              if (mu__boolexpr30) {
                if ( ( TRUE  ) )
                  return;
...
public:
  ...
  mu_1_ProcState& mu_p = mu_proc_state[mu_i];
bool mu__boolexpr32;
  if ((mu_p.mu_state) == (mu_FB_EM)) mu__boolexpr32 = TRUE ;
  else {
  mu__boolexpr32 = ((mu_p.mu_state) == (mu_FB_PEMR)) ; 
}
...
bool mu__boolexpr34;
  ...
  mu__boolexpr34 = ((mu_p.mu_state) == (mu_FB_PEMW)) ; 
}
  ...
  mu_1_ProcState& mu_p = mu_proc_state[mu_i];
bool mu__boolexpr35;
  if ((mu_p.mu_state) == (mu_FB_EM)) mu__boolexpr35 = TRUE ;
  else {
  mu__boolexpr35 = ((mu_p.mu_state) == (mu_FB_PEMW)) ; 
}
              if (mu__boolexpr35) {
                if ( ( TRUE  ) )
                  return;
...
bool mu__boolexpr36;
bool mu__boolexpr37;
  if ((mu_p.mu_state) == (mu_FB_SU)) mu__boolexpr37 = TRUE ;
  else {
  mu__boolexpr37 = ((mu_p.mu_state) == (mu_FB_EU)) ; 
}
  if (mu__boolexpr37) mu__boolexpr36 = TRUE ;
  else {
  mu__boolexpr36 = ((mu_p.mu_state) == (mu_FB_EM)) ; 
}
...
bool mu__boolexpr38;
bool mu__boolexpr39;
  if ((mu_p.mu_state) == (mu_FB_SU)) mu__boolexpr39 = TRUE ;
  else {
  mu__boolexpr39 = ((mu_p.mu_state) == (mu_FB_EU)) ; 
}
  if (mu__boolexpr39) mu__boolexpr38 = TRUE ;
  else {
  mu__boolexpr38 = ((mu_p.mu_state) == (mu_FB_EM)) ; 
}
              if (mu__boolexpr38) {
                if ( ( TRUE  ) )
                  return;
...
/********************
  Invariant records
 ********************/
int mu__invariant_40() // Invariant "value is undefined while invalid"
{
bool mu__quant41; 
mu__quant41 = TRUE;
{
...
bool mu__boolexpr42;
  if (!((mu_proc_state[mu_n].mu_state) == (mu_FB_I))) mu__boolexpr42 = TRUE ;
  else {
  mu__boolexpr42 = (mu_proc_state[mu_n].mu_value.isundefined()) ; 
}
if ( !(mu__boolexpr42) )
...
bool mu__condition_43() // Condition for Rule "value is undefined while invalid"
{
...
int mu__invariant_44() // Invariant "values in valid state match last write"
{
bool mu__quant45; 
mu__quant45 = TRUE;
{
...
bool mu__boolexpr47;
bool mu__boolexpr48;
  if ((mu_proc_state[mu_n].mu_state) == (mu_FB_SU)) mu__boolexpr48 = TRUE ;
  else {
  mu__boolexpr48 = ((mu_proc_state[mu_n].mu_state) == (mu_FB_EM)) ; 
}
  if (mu__boolexpr48) mu__boolexpr47 = TRUE ;
  else {
  mu__boolexpr47 = ((mu_proc_state[mu_n].mu_state) == (mu_FB_EU)) ; 
}
  if (!(mu__boolexpr47)) mu__boolexpr46 = TRUE ;
  else {
  mu__boolexpr46 = ((mu_proc_state[mu_n].mu_value) == (mu_last_write)) ; 
}
if ( !(mu__boolexpr46) )
...
int mu__invariant_50() // Invariant "only one processor in EU state"
{
bool mu__quant51; 
mu__quant51 = TRUE;
{
...
bool mu__boolexpr53;
bool mu__boolexpr54;
  if (!((mu_proc_state[mu_p1].mu_state) == (mu_FB_EU))) mu__boolexpr54 = FALSE ;
  else {
  mu__boolexpr54 = ((mu_proc_state[mu_p2].mu_state) == (mu_FB_EU)) ; 
}
  if (!(mu__boolexpr54)) mu__boolexpr53 = TRUE ;
  else {
  mu__boolexpr53 = ((mu_p1) == (mu_p2)) ; 
}
if ( !(mu__boolexpr53) )
...
bool mu__condition_55() // Condition for Rule "only one processor in EU state"
{
...
int mu__invariant_56() // Invariant "only one processor in EM state"
{
bool mu__quant57; 
mu__quant57 = TRUE;
{
...
bool mu__boolexpr59;
bool mu__boolexpr60;
  if (!((mu_proc_state[mu_p1].mu_state) == (mu_FB_EM))) mu__boolexpr60 = FALSE ;
  else {
  mu__boolexpr60 = ((mu_proc_state[mu_p2].mu_state) == (mu_FB_EM)) ; 
}
  if (!(mu__boolexpr60)) mu__boolexpr59 = TRUE ;
  else {
  mu__boolexpr59 = ((mu_p1) == (mu_p2)) ; 
}
if ( !(mu__boolexpr59) )
...
bool mu__condition_61() // Condition for Rule "only one processor in EM state"
{
...
{"only one processor in EM state", &mu__condition_61, NULL, FALSE},
{"only one processor in EU state", &mu__condition_55, NULL, FALSE},
{"values in valid state match last write", &mu__condition_49, NULL, FALSE},
{"value is undefined while invalid", &mu__condition_43, NULL, FALSE},
};
